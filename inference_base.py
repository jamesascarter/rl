#!/usr/bin/env python3
"""
Base inference for Qwen model without LoRA fine-tuning
"""
...
def generate_summary_base(text: str) -> str:
    """
    Generate a summary using the base Qwen model (no fine-tuning)
...
if __name__ == "__main__":
    ...
    summary = generate_summary_base(text)
    print(f"Prompt: {text}")
    print("--------------------------------")
    print(f"Base Model Summary: {summary}") 